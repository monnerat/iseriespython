             ...
             DTD *dtd)
{
  ...
  if (memsuite) {
    ...
    if (parser != NULL) {
      mtemp = (XML_Memory_Handling_Suite *)&(parser->m_mem);
#ifdef __ILEC400__
      mtemp->malloc_fcn = (void* __ptr128(* __ptr128)(unsigned int))malloc;
      mtemp->realloc_fcn = (void* __ptr128(* __ptr128)(void* __ptr128, unsigned int))realloc;
      mtemp->free_fcn = (void(* __ptr128)(void* __ptr128))free;
#else

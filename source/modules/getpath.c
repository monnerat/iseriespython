...
static char proglib[11];
static char progobjname[11];
#endif
...
isfile(char *filename)          /* Is file, not directory */
{
    struct stat buf;
#ifdef __ILEC400__
    if (stat(utfToStr(filename, e_buf), &buf) != 0)
#else
